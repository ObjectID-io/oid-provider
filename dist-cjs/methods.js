...
exports.add_approver_did = add_approver_did;
exports.add_document_credit = add_document_credit;
exports.add_editors_did = add_editors_did;
exports.alert_message = alert_message;
exports.anonymous_message = anonymous_message;
exports.append_change_log = append_change_log;
exports.approve_document = approve_document;
exports.control_message = control_message;
exports.counter_set_value = counter_set_value;
exports.counter_stepdown = counter_stepdown;
exports.counter_stepup = counter_stepup;
...
exports.creator_message = creator_message;
...
exports.remove_approver_did = remove_approver_did;
exports.remove_editors_did = remove_editors_did;
exports.update_agent_did = update_agent_did;
exports.update_document_mutable_metadata = update_document_mutable_metadata;
exports.update_document_owner_did = update_document_owner_did;
exports.update_document_status = update_document_status;
exports.update_document_url = update_document_url;
exports.update_document_url_hash = update_document_url_hash;
exports.update_event_mutable_metadata = update_event_mutable_metadata;
exports.update_geo_location = update_geo_location;
exports.update_geolocation = update_geolocation;
exports.update_object = update_object;
exports.update_object_did = update_object_did;
exports.update_object_mutable_metadata = update_object_mutable_metadata;
exports.update_op_code = update_op_code;
exports.update_owner_did = update_owner_did;
exports.update_publisher_did = update_publisher_did;
...
async function add_approver_did(api, params) {
    ...
    const r = await (0, tx_1.signAndExecute)(env.client, env.keyPair, tx, { network: env.network, gasBudget, useGasStation: api.useGasStation, gasStation: api.gasStation });
    return r;
}
...
async function create_document(api, params) {
    ...
    tx.moveCall({
        arguments: [
            ...
            tx.pure.string(description),
            tx.pure.string((0, env_1.asJsonString)(immutable_metadata)),
            tx.pure.string((0, env_1.asJsonString)(mutable_metadata)),
            tx.object("0x6"),
        ],
        target: moveFunction,
    });
...
async function update_document_mutable_metadata(api, params) {
    ...
    tx.moveCall({
        arguments: [
            tx.object(controllerCap),
            tx.object(document),
            tx.pure.string((0, env_1.asJsonString)(new_mutable_metadata)),
            tx.object("0x6"),
        ],
        target: moveFunction,
    });
